...
namespace WebApplicationLibraryManagement
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
            ...
            if (checkifBookExist())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            Response.Write("<script>alert( 'Actual Stock cannot be lessthan the Issued Books'); </script>");
                            return;
                        }
                        else
                        {
                    ...
                    cmd.Parameters.AddWithValue("@no_of_page", TextBox9.Text.Trim());
        ...
        void getBookById()
        {
            try
            {
                ...
                if (dt.Rows.Count >=1)
                {
                    ...
                    TextBox9.Text = dt.Rows[0]["no_of_page"].ToString().Trim();
        ...
        //author name field dropdownlist and publisher name 
        void fillAuthorPublsiherValues()
        {
            try
            {
                SqlConnection con = new SqlConnection(strcon);
        ...
        void addNewBook()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Insert into  book_master_tbl (book_id,book_name,genre,author_name,publisher_name,publish_date,language,edition,book_cost,no_of_page,book_description,actual_stock,current_stock,book_img_link) values (@book_id,@book_name,@genre,@author_name,@publisher_name,@publish_date,@language,@edition,@book_cost,@no_of_page,@book_description,@actual_stock,@current_stock,@book_img_link)", con);
