<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="WebApplicationLibraryManagement.adminauthormanagement" %>
                    ...
                    <div class="card-body">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label>Athor Name</label>
                                <div class="mb-3" >

                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Athor Name" ></asp:TextBox>
