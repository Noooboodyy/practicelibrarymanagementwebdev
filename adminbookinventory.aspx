<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="WebApplicationLibraryManagement.adminbookinventory" %>
                       ...
                       <%-- Choose Files --%>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                                        ...
                                        <asp:ListItem Text="Taglog" Value="Tagalog" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:ListBox  CssClass="form-control" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="5">
                                        ...
                                        <asp:ListItem Text="Historical Non-fiction" Value="Historical Non-fiction" />
                                        <asp:ListItem Text="Biography/Memoir" Value="Biography/Memoir" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 d-grid gap-2 ">
                                ...
                                <asp:Button class="btn btn-lg btn-block btn-primary" ID="Button3" runat="server" Text="Update " OnClick="Button3_Click" />
                                                       ...
                                                       <div class="col-lg-10">
                                                           ...
                                                           <div class="row">
                                                               <div class="col-12">
                                                                   ...
                                                                   &nbsp;| Pages-<asp:Label ID="Label7" runat="server" Font-Bold="True" Text='<%# Eval("no_of_page") %>'></asp:Label>
